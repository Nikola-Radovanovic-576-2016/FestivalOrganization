...
{
    public partial class UpdateConcert : Form
    {
        public int koncertlId { get; set; }
        ...
        private void UpdateConcert_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = @"UPDATE Koncert SET ime_koncerta='" + naziv +"',id_festivala='" + id_fest + "',vreme_pocetka='" + pocetak + "',vreme_zavrsetka='"+kraj+"',id_bine='" + id_bine + "' WHERE id_koncerta='" + koncertlId + "'" ;
                SqlCommand command = new SqlCommand(query, connection);
                SqlDataAdapter adapter = new SqlDataAdapter();
                adapter.InsertCommand = command;
                adapter.InsertCommand.ExecuteNonQuery();
                command.Dispose();
                MessageBox.Show("Izmenjen izabrani koncert");
                this.Close();
            }
            else
